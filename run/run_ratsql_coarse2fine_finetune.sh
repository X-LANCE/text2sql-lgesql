task=ratsql_coarse2fine_finetune
seed=999
device=0
preprocess='--preprocess'
testing='' #'--testing'
read_model_path='--read_model_path exp_debug/graph_pruning_pretrain/emb_300__gnn_256_x_8_shared_8__head_8__dp_0.2__attndp_0.0__method_multihead-attention__score_fnn__bce_ls_0.15__init_0.2__bsize_20__lr_0.0005__l2_0.0001__warmup_0.1__schedule_linear__me_100__mn_5.0' # '--read_model_path exp/../'
...
python scripts/ratsql_coarse2fine_finetune.py --task $task --seed $seed --device $device $preprocess $testing $read_model_path \
