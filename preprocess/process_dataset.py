...
def process_dataset(processor, dataset, tables, output_path=None, verbose=False):
...
if __name__ == '__main__':
    ...
    start_time = time.time()
    dataset = process_dataset(processor, dataset, tables, args.output_path, verbose=args.verbose)
